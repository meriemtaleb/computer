...
<head>
    ...
    <title>متجر حمودة - HP Elitebook 830 x360 G8</title>
        ...
        <div class="container">
            <div class="product-detail">
                <div class="product-gallery">
                    <img src="{{ asset('storage/'.$product->image) }}" alt="{{ $product->title }}" class="main-image" id="mainProductImage">
                </div>
                    ...
                    <div class="basic-info">
                        ...
                        <div class="technical-specs">
                            <div class="specs-grid">
                                <div class="spec-item">
                                    ...
                                    <span>المعالج: {{ $product->cpu }}</span>
                                </div>
                                <div class="spec-item">
                                    <i class="fas fa-memory"></i>
                                    <span>الذاكرة: {{ $product->ram }}</span>
                                </div>
                                <div class="spec-item">
                                    <i class="fas fa-hdd"></i>
                                    <span>التخزين: {{ $product->storage }}</span>
                                </div>
                                <div class="spec-item">
                                    <i class="fas fa-tv"></i>
                                    <span>الشاشة: {{ $product->screen }}</span>
                                </div>
                                <div class="spec-item">
                                    <i class="fas fa-keyboard"></i>
                                    <span>لوحة المفاتيح: {{ $product->keybored }}</span>
                                </div>
                                <div class="spec-item">
                                    <i class="fas fa-battery-full"></i>
                                    <span>الشاحن: {{ $product->charger }}</span>
                                </div>
                                <div class="spec-item">
                        ...
                        <div class="action-buttons">
                            <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                @csrf
                                <button class="btn" aria-label="إضافة إلى السلة">
                                    <i class="fas fa-shopping-cart"></i> إضافة إلى السلة
                                </button>
                            </form>
                            <a href="{{ route('order.create', ['product_id' => $product->id]) }}" class="btn" aria-label="اشتر الآن">
            ...
            <div class="footer-content">
                <div class="footer-column">
                    ...
                    <div class="social-links">
                        <a class="facebook" href="https://www.facebook.com/Hamouda.Shoop18" aria-label="فيسبوك">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a class="insta" href="https://www.instagram.com/hamouda_shop_/" aria-label="إنستغرام">
